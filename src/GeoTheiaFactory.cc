...
G4VSolid *GeoTheiaFactory::ConstructSolid(RAT::DBLinkPtr table) {
  // Inner radius of cylindrical part of Theia
  G4double r_min = table->GetD("r_min");
  // Outer radius of cylindrical part of Theia
  G4double r_max = table->GetD("r_max");
  // Half-height of cylindrical part of Theia
  ...
  G4VSolid *TheiaVolumeP1 = new G4UnionSolid("theia_v1", body, head, *transf);
  ...
  G4UnionSolid *TheiaVolume = new G4UnionSolid("theia", TheiaVolumeP1, bot, *neg_transf);
